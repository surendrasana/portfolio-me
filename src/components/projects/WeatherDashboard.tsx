    ...
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">
          Comprehensive weather data with real-time updates and detailed
          forecasts
        </p>
      </div>
      ...
      {/* Main Weather Card */}
      <Card
        className={`bg-gradient-to-br ${getConditionGradient(
      ...
      <div className="grid md:grid-cols-4 lg:grid-cols-6 gap-4">
        ...
        <Card>
          <CardContent className="p-4 text-center">
            ...
            <div
              className={`text-2xl font-bold ${getAirQualityColor(
            ...
            <div
              className={`text-xs ${getAirQualityColor(
                weatherData.airQuality.index
              )}`}
            >
                  ...
                  <div className="flex items-center gap-4 flex-1">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-gray-600">
                        Precipitation: {day.precipitation}% | Wind:{" "}
                        {day.windSpeed} mph | Humidity: {day.humidity}%
                      </div>
                    </div>
                  </div>
        ...
        <CardContent>
          <div className="grid md:grid-cols-5 gap-4">
            <div className="text-center">
              <div
                className={`text-3xl font-bold ${getAirQualityColor(
                  weatherData.airQuality.index
                )}`}
              >
                {weatherData.airQuality.index}
              ...
              <div
                className={`text-sm font-medium ${getAirQualityColor(
                  weatherData.airQuality.index
                )}`}
              >
                {weatherData.airQuality.quality}
          ...
          <div className="h-48 bg-gradient-to-r from-blue-100 to-orange-100 rounded-lg flex items-end justify-between p-4 relative">
            ...
            {weatherData.hourlyForecast.map((hour, i) => (
              <div
                ...
                title={`${hour.time}: ${convertTemperature(
                  hour.temperature
                )}°${temperatureUnit}`}
              />
            ))}
